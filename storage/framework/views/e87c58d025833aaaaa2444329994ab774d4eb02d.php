        ...
        <div class="row row-cols-2" >
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card text-black m-3" style="width: 275px">
                    ...
                    <?php else: ?>
                        <div class="cart mt-1 mb-3">
                            <a href="/signin" class=""> Add to Cart</a>
                        </div>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make("template.guest", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Joseph\BINUS\Semester 5\Web Programming\LAB\Project\project\resources\views/guest/product.blade.php ENDPATH**/ ?>